...
// We never scrape LinkedIn. Uses Claude (Anthropic) if ANTHROPIC_API_KEY is set,
// otherwise OpenAI if OPENAI_API_KEY is set, otherwise a deterministic heuristic
// so the endpoint always works.
